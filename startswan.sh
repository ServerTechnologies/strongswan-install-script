...
sudo apt install strongswan strongswan-pki libcharon-extra-plugins libcharon-extauth-plugins libtss2-tcti-tabrmd0 libstrongswan-extra-plugins libstrongswan-standard-plugins -y
mkdir -p ~/pki/cacerts
mkdir -p ~/pki/certs
mkdir -p ~/pki/private

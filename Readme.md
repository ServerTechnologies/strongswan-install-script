...
> В последнее время этот протокол блокируется во многих регионах, рекомендую использовать другие протоколы, вот видео по актуальным протоколам: \
https://youtu.be/cqALGtCBgoI \
https://youtu.be/XASBkzQE00s \
https://youtu.be/PHn5JE9rXgg \
https://youtu.be/yTHhXdIrxlw \
https://youtu.be/MGUtKP-qvLU 
